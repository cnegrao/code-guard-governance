 ...
 * DiscoveryFinding (and, when Discovery Intake actually produced one —
 * today only for RELATIONSHIP kind, see discovery-intake-port.ts)
 * NormalizedCandidate backing a ReviewSubject, and hands them to
 * governance-review's pure recoverReconciliationInput for the
